...
//list booking 
    public:
    Show(string ID_Show, string date, string startTime, Movie* movie, DoubleLinkedList<ShowSeat> seatLayout, Screen* screen);
    //getter
    string getID_Show();
    string getStartTime();
    Movie* getMovie();
    ...
    static DoubleLinkedList<Show> loadShowFromFile(string fileName);
    
    friend void saveShowToFile(string fileName);
