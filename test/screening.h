...
private:
    ...
    bool saveToFile();
    static bool overwriteFile(DoubleLinkedList<Screening> s);
public:
    Screening();
    ...
    static void viewScreenings(const DoubleLinkedList<Screening>& screenings);
    static void deleteScreening(DoubleLinkedList<Screening>& screenings);
    static void readFile(DoubleLinkedList<Screening>& screenings);
